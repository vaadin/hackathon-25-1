...
- **`com.herberts.base`**: Reusable components and base classes for all features
...
- **`com.herberts.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `com.herberts` (e.g., `com.herberts.myfeature`)
